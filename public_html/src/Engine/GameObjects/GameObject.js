...
GameObject.prototype.update = function() {
  ...
  if (this.mRigidBody !== null) this.mRigidBody.update();
};

GameObject.prototype.draw = function(aCamera) {
  if (this.isVisible()) {
    if (this.mDrawRenderable) this.mRenderComponent.draw(aCamera);
    if (this.mRigidBody !== null && this.mDrawRigidShape) this.mRigidBody.draw(aCamera);
  }
};
